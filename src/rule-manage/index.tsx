...
import { Container, Paper, Table, TableBody, TableContainer, Stack, Card, Box, TablePagination, FormControlLabel, Switch } from '@mui/material';
          ...
          <Stack spacing={3}>
            <TableContainer sx={{ minWidth: 800, position: 'relative' }}>
              <Table size={dense ? 'small' : 'medium'}>
                <TableHeadCustom order={order} orderBy={orderBy} headLabel={CHILD_TRACKER_TABLE_HEAD} />
                <TableBody>
