...
import { useGetListNameChild } from '../../../name_child/hooks/useGetListNameChild';
...
export default function CategoryDashBoard() {
  ...
  const { data, isLoading } = useGetListMusic(searchParams) as any;
  console.log(data);
  ...
  return (
    <Card sx={{ padding: 3 }}>
      <ConfirmModal
        ...
        type={'delete'}
        text={'Bạn có chắc muốn xóa bài nhạc đã chọn?'}
      />
      <Scrollbar>
