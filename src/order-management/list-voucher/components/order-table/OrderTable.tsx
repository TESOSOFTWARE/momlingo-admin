...
export default function OrderTable({ smallTable, searchUserId }: Props) {
  const {
    dense,
    page,
    order,
  ...
  return (
    <>
      <OrderFilter searchUserId={searchUserId} onSetPage={setPage} />
      ...
      <Paper elevation={3}>
        <TableContainer sx={{ position: 'relative' }}>
          ...
          <Table size={smallTable ? 'medium' : dense ? 'small' : 'medium'}>
            <TableHeadCustom
