  ...
  return (
    <TableRow hover selected={selected}>
      ...
      <TableCell
        ...
        onClick={() => navigate(PATH_DASHBOARD.category.edit(id))}
      >
        {categoryDetailsVN?.name}
      </TableCell>
      <TableCell align="left">{categoryDetailsVN?.slug}</TableCell>
      <TableCell align="left">{categoryDetailsVN?.desc}</TableCell>
