...
} from '../statisticSpoonUnused.slice';
    ...
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">
          {t('analystSpoonUnused.export.titleConfirmExport')}
        </DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {t('analystSpoonUnused.export.subtitleConfirmExport')}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleClose} color="inherit" variant="contained">
            {t('analystSpoonUnused.export.closeConfirmExport')}
          </Button>
          <Button onClick={handleAgree} autoFocus color="warning" variant="contained">
            {t('analystSpoonUnused.export.agreeConfirmExport')}
          </Button>
        </DialogActions>
      </Dialog>
    </div>
