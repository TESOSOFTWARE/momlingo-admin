...
import { ISearchForm, stableSort } from '../../interface';
...
import { useGetGameChart } from '../hooks/useGetGameChart';
import { useGetGameChartPie } from '../hooks/useGetGameChartPie';
...
import { TABLE_HEAD_GAME } from '../../constants';
...
export default function GameChart() {
  ...
  const { searchParamsGame } = useSelector((state) => state.chart);
  useEffect(() => {
    return () => {
