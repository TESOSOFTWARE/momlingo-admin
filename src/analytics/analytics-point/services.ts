import { API_CATEGORY, API_GET_LIST_USER, API_STATISTIC_POINT } from '../../common/constants/apis';
...
export const getStatisticPointCircleChart = (params: any) => {
  return axiosInstance.get<unknown, IResCircleChart>(`${API_STATISTIC_POINT}/overview`, { params });
};

export const getStatisticPointLineChart = (params: any) => {
    return axiosInstance.get<unknown, IResLineChart[]>(`${API_STATISTIC_POINT}/line-chart`, { params });
  };
